...
export const PT: Record<string, string> = {
  ...
  'Importar CSV o Excel': 'Importar CSV ou Excel',
  ...
  'Cargo en la cuenta': 'Débito na conta',
  'Cargo por ajuste': 'Débito por ajuste',
  Compra: 'Compra',
  'Configuración de crédito': 'Configuração de crédito',
  'Crédito en la cuenta': 'Crédito na conta',
  ...
  'Nota de crédito / descuento': 'Nota de crédito / desconto',
  ...
  'Podés ver el detalle de tu cuenta acá:': 'Você pode ver o detalhe da sua conta aqui:',
  ...
  'Te confirmamos que registramos tu pago de': 'Confirmamos que registramos seu pagamento de',
  'Te paso el resumen de tu cuenta': 'Te mando o resumo da sua conta',
  'Te recordamos que tenés un pago pendiente de': 'Te lembramos que você tem um pagamento pendente de',
  'con vencimiento el': 'com vencimento em',
  '¡Gracias!': 'Obrigado!',
  'Te registramos un movimiento en tu cuenta por': 'Registramos uma movimentação na sua conta de',
  ...
  'Volver al cliente': 'Voltar para o cliente',
  disponible: 'disponível',
  en: 'em',
  saldo: 'saldo',
  vence: 'vence',
  ...
  'Vence el': 'Vence em',
  'Enviar recordatorio por WhatsApp': 'Enviar lembrete por WhatsApp',
  Ver: 'Ver',
  ...
  'No había': 'Não havia',
  'No se pudo traer todo para el respaldo': 'Não foi possível trazer tudo para o backup',
  'No tenés permiso para ver esta sección.': 'Você não tem permissão para ver esta seção.',
  'no se borró nada. Volvé a intentar en unos minutos.': 'nada foi excluído. Tente novamente em alguns minutos.',
  ...
  'Ubicación física (ej. Estante A-3, Tribuna)': 'Localização física (ex. Prateleira A-3, vitrine)',
  'Ej. Estante A-3, Tribuna': 'Ex. Prateleira A-3, vitrine',
  'Agregar ubicación': 'Adicionar localização',
  ...
  'Tipo de equipo': 'Tipo de aparelho',
  Notebook: 'Notebook',
  Tablet: 'Tablet',
  Parlante: 'Caixa de som',
  'Bloqueo del equipo (opcional)': 'Bloqueio do aparelho (opcional)',
  'Bloqueo del equipo': 'Bloqueio do aparelho',
  'Bloqueo:': 'Bloqueio:',
  PIN: 'PIN',
  Patrón: 'Padrão',
  'Reiniciar patrón': 'Reiniciar padrão',
  'Tipo:': 'Tipo:',
  'Código de desbloqueo': 'Código de desbloqueio',
  Demorada: 'Atrasado',
  ...
  'Compra #': 'Compra #',
  'Comprobante de ajuste': 'Comprovante de ajuste',
  'Comprobante de cargo': 'Comprovante de débito',
  'Comprobante de crédito': 'Comprovante de crédito',
  'Comprobante de deuda': 'Comprovante de dívida',
  'Comprobante de pago': 'Comprovante de pagamento',
  'Comprobante de venta': 'Comprovante de venda',
